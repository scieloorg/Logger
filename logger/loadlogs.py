                ...
                if "GET" in line and ".pdf" in line:
                    ...
                    if validate_date(dat):
                        ...
                        if validate_pdf(pdfid, acronDict):
                            ...
                            qrs = "code={0}&page=download&access_date={1}".format(issn, dat)
                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/general", qrs)
                            urllib2.urlopen(req)
                            qrs = "code=www.scielosp.org&page=download&access_date={0}".format(dat)
                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/general", qrs)
                            urllib2.urlopen(req)
                #PAGES PATTERN
                        ...
                        if script in ALLOWED_SCRIPTS:  # Validation if the script is allowed
                            if validate_date(dat):
                                ...
                                if 'pid' in par:
                                    ...
                                    if validate_pid(script, pid, allowed_issns):
                                        # CREATING SERIAL LOG DOCS
                                        if script == "sci_serial":
                                            # ISSUE ACCESS
                                            qrs = "code={0}&access_date={2}".format(pid, pid[0:9], dat)
                                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/journal", qrs)
                                            urllib2.urlopen(req)
                                            qrs = "code=www.scielosp.org&page=sci_serial&access_date={0}".format(dat)
                                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/general", qrs)
                                            urllib2.urlopen(req)
                                            qrs = "code={0}&page=sci_serial&access_date={1}".format(pid[0:9], dat)
                                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/general", qrs)
                                            urllib2.urlopen(req)
                                            ...
                                            urllib2.urlopen(req)
                                            qrs = "code=www.scielosp.org&page=sci_abstract&access_date={0}".format(dat)
                                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/general", qrs)
                                            urllib2.urlopen(req)
                                            qrs = "code={0}&page=sci_abstract&access_date={1}".format(pid[0:9], dat)
                                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/general", qrs)
                                            urllib2.urlopen(req)
                                            ...
                                            urllib2.urlopen(req)
                                            qrs = "code=www.scielosp.org&page=sci_issuetoc&access_date={0}".format(dat)
                                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/general", qrs)
                                            urllib2.urlopen(req)
                                            qrs = "code={0}&page=sci_issuetoc&access_date={1}".format(pid[0:9], dat)
                                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/general", qrs)
                                            urllib2.urlopen(req)
                                        elif script == "sci_arttext":
                                            qrs = "code={0}&journal={1}&issue={2}&access_date={3}".format(pid, pid[0:9], pid[0:17], dat)
                                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/article", qrs)
                                            urllib2.urlopen(req)
                                            qrs = "code=www.scielosp.org&page=sci_arttext&access_date={0}".format(dat)
                                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/general", qrs)
                                            urllib2.urlopen(req)
                                            qrs = "code={0}&page=sci_arttext&access_date={1}".format(pid[0:9], dat)
                                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/general", qrs)
                                            urllib2.urlopen(req)
                                        elif script == "sci_pdf":
                                            qrs = "code={0}&journal={1}&issue={2}&access_date={3}".format(pid, pid[0:9], pid[0:17], dat)
                                            ...
                                            urllib2.urlopen(req)
                                            qrs = "code=www.scielosp.org&page=sci_pdf&access_date={0}".format(dat)
                                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/general", qrs)
                                            urllib2.urlopen(req)
                                            qrs = "code={0}&page=sci_pdf&access_date={1}".format(pid[0:9], dat)
                                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/general", qrs)
                                            urllib2.urlopen(req)
                                        elif script == "sci_home":
                                            qrs = "code=www.scielosp.org&page=sci_home&access_date={0}".format(dat)
                                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/general", qrs)
                                            urllib2.urlopen(req)
                                        elif script == "sci_issues":
                                            qrs = "code=www.scielosp.org&page=sci_issues&access_date={0}".format(dat)
                                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/general", qrs)
                                            urllib2.urlopen(req)
                                            qrs = "code={0}&page=sci_issues&access_date={1}".format(pid[0:9], dat)
                                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/general", qrs)
                                            urllib2.urlopen(req)
                                        elif script == "sci_alphabetic":
                                            qrs = "code=www.scielosp.org&page=sci_alphabetic&access_date={0}".format(dat)
                                            req = urllib2.Request("http://200.136.72.14:8860/api/v1/general", qrs)
                                            urllib2.urlopen(req)
            fileloaded.close()
else:
